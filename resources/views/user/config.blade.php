    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-header">Mis configuraciones</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" aria-label="{{ __('Register') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="image_path" class="col-md-4 col-form-label text-md-right">Foto</label>
